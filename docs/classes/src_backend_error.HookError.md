[ghostmeme.api.hscc.bdpa.org](../README.md) / [src/backend/error](../modules/src_backend_error.md) / HookError

# Class: HookError

[src/backend/error](../modules/src_backend_error.md).HookError
...
- [constructor](src_backend_error.HookError.md#constructor)

### Properties

- [message](src_backend_error.HookError.md#message)
- [name](src_backend_error.HookError.md#name)
- [stack](src_backend_error.HookError.md#stack)
- [prepareStackTrace](src_backend_error.HookError.md#preparestacktrace)
- [stackTraceLimit](src_backend_error.HookError.md#stacktracelimit)

### Methods

- [captureStackTrace](src_backend_error.HookError.md#capturestacktrace)
